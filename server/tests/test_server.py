...
from tests.network_class import Network


class Test_Server(TestCase):

    """server.server.Server unit tests class"""

    def __init__(self, *args, **kwargs):
        super(Test_Server, self).__init__(*args, **kwargs)
